    ...
    def __init__(self, **kwargs):
        ...
        with self.canvas:
            self.rect = Rectangle(
                ...
                source="src/premium asset pack/Premium Undead Animations/Mummified Ritualist/momia.gif"
            )

        # si se mueve la momia, mover el gif
